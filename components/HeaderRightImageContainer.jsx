...
function HeaderRightImageContainer() {
  return (
    <div className="order-1 md:order-2 static  overflow-hidden  h-[35rem] mb-[-8rem] md:mb-0 ">
      ...
      <div className=" absolute w-[22rem]   md:w-[21.6rem] lg:w-[32.4rem]  md:right-0  lg:right-0 top-[-1rem] md:top-[0rem] left-0 md:left-auto  lg:left-auto  right-0  mx-auto  overflow-x-hidden   ">
